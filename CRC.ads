...
package CRC is
   ...
   subtype Crc_Table_Range is Unsigned_8;
   type Crc_Table_Array_T is array (Crc_Table_Range range <>) of Unsigned_32;
   ...
   Crc_Table : Crc_Table_Array_T (Crc_Table_Range) := (others => 0);
   ...
   ---------------------------------------------------------------------
   procedure Generate_Table(Name : Crc_Name_T := CRC_CCITT);
